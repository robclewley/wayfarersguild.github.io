...
BLOG_AUTHOR = "Wayfarers"  # (translatable)
BLOG_TITLE = "Wayfarers' Guild"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://github.com/wayfarersguild/wayfarersguild.github.io/"
...
POSTS = (
    ("src/wayfarers/docs/*.ipynb", "posts", "post.tmpl"),
    #("src/wayfarers/*.ipynb", "posts", "post.tmpl"),
)
